# ServiceNow Client-Side Scripting & APIs: Master Reference Library

Welcome to the **ServiceNow Developer Client-Side Reference Library**. This repository contains a curated collection of executive-grade study plans, reference manuals, code cheat sheets, and print-ready textbooks. It is designed to take developers from basic javascript concepts to advanced client-server integration patterns within the ServiceNow platform.
...
### 1. ServiceNow Client Script Triggers Reference Manual
...
### 2. GlideForm (`g_form`) Master Reference Manual
...
### 3. GlideUser (`g_user`) Manual & Code Catalog
...
### 4. JavaScript for ServiceNow Cheat Sheet
...
### 6. 5-Hour Client-Side Scripting Study Plan
